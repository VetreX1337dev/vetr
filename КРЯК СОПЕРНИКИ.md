-- [[ ВСТАВЛЯТЬ В САМОЕ НАЧАЛО СКРИПТА ]] --

local Obsidian = loadstring(game:HttpGet("https://raw.githubusercontent.com/deividcomsono/Obsidian/main/Library.lua"))()

-- ПАТЧ: Отключаем систему ключей навсегда
local OriginalNew = Obsidian.new
Obsidian.new = function(Settings)
    Settings = Settings or {}
    Settings.KeySystem = false -- Выключаем ключ принудительно
    return OriginalNew(Settings)
end

-- [[ НИЖЕ ИДЕТ ТВОЙ СКРИПТ ]] --
